...
Btw go check out my blog [here](https://ajulusthoughts.wordpress.com). Topics range from Technology, Cybersecurity, Ethical Hacking, Privacy, Anonymity to Self Improvement, Career, Business, Fashion and Fitness.
...
##### I went with Jekyll instead of WordPress because:
 - **Jekyll is fast** - It's a static site what does one expect. Though i wish it was faster. According to [GTMetrics](https://gtmetrix.com/reports/ajulusthoughts.github.io/z77kdt5W). My site's YSlow and Pagespeed rating is 78% with a page load of 1.1s. Mobile rating is 74%, Desktop rating 97%.
...
- Android 7.1.1-
- This is my primary device, it has Termux(With Kali Nethunter rootfs and a few ported and compiled scripts and tools) and Userland(Ubuntu, Kali Linux, Arch Linux rootfs) installed, i use it for places i cannot carry my laptop and ofcourse communication and social media it also contains alot of other apps you can read about here: <a href="https://ajulusthoughts.wordpress.com/2019/01/06/the-apps-ajulu-uses-on-his-android-phone-nokia-6-2017/">Apps I Run on my Smartphone</a>
...
- Feature Phone
- 750GB External HDD
- 2500mAh Powerbank<br>Tablet Keyboard(For typing on my Nokia)
- USB Mouse
